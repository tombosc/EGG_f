...
python -m egg.zoo.vary_distr.play --print_validation_events --batch_size=256 --random_seed=1 --max_len 5 --lr=0.01 --n_epochs=100 --vocab_size 10 --sender_entropy_coef 0.1 --length_coef 0.1 --min_distractors 3 --max_distractors 10 --n_features 4 --sender_type=tfm --embed_dim 16 --n_layers 2 --n_heads 4 --log_length=False --receiver_hidden=30 --no_cuda --optimizer sgd --grad_norm 1
